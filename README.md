...
This required pulling in another 3rd party dependency, [stb_image](https://github.com/nothings/stb), for loading in the texture image itself.  In theory, I think SDL2 could do this, but for now I'm just on for the ride.
