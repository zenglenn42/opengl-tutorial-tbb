...
#-----------------------
# SDL2-widgets-2.1.tar.gz
#
# http://members.chello.nl/w.boeke/SDL-widgets/SDL2-widgets-2.1.tar.gz
#-----------------------
sdl2widgets_VERSION = 2.1
sdl2widgets_SRC_GZ = $(dep_ZIP_DIR)/SDL2-widgets-$(sdl2widgets_VERSION).tar.gz
...
install: $(dep_INSTALL_DIR) $(glew_Install) $(glm_Install) $(sdl2_Install) $(debugbreak_Install) $(stb_Install) $(ft_Install) $(sdl2ttf_Install) 
...
$(sdl2widgets_Install):
	cd $(sdl2widgets_SRC_DIR) && cp sdl-widgets.a $@
